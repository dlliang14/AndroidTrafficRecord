...
class Tester :#line:17
    def __init__ (self ,download_folder ,pcap_folder ,wait_time ,monkey_count ,file_info ,brand ,pcapsizethreshold ,onlyhuman  ,showlogs  ,tf_flag ,maxpcapsizethreshold ,disableapp  ,installtimelimit ):#line:18
        warnings .filterwarnings ("ignore")#line:19
        self .__download_folder =download_folder #line:20
        self .__pcap_folder =pcap_folder #line:21
        self .__wait_time =wait_time #line:22
        self .__monkey_count =monkey_count #line:23
        self .__file_info =file_info #line:24
        self .__brand =brand #line:25
        self .__onlyhuman =onlyhuman  #line:26
        self .__O0O00OO00O0OOOO00 =0 #line:27
        self .__showlogs =showlogs  #line:28
        self .__tf_flag =tf_flag #line:29
        self .__pcapsizethreshold =pcapsizethreshold #line:30
        self .__maxpcapsizethreshold =maxpcapsizethreshold #line:31
        self .__disableapp =disableapp  #line:32
        self .__installtimelimit =installtimelimit #line:33
        self .__OO0OO0000O0OO00OO =os .path .dirname (__file__ )#line:34
        self .__OOO00OO00OO0OO0O0 =False #line:35
        if self .__onlyhuman :#line:36
            keyboard .hook (self .__OO0OOO000O0O0OOOO )#line:37
        self .__OO00O00O00000OO00 =threading .Lock ()#line:40
        if not self .__tf_flag :#line:41
            if not os .path .exists (self .__pcap_folder ):#line:42
                os .makedirs (self .__pcap_folder )#line:43
            O0O000OOO000O0O0O =self .__OO0OOOO0O00O000OO ()#line:44
            ...
            self .__O0O00OO000OO00O0O =pd .read_csv ("./ATR_result.csv",encoding ="gb2312")#line:48
            O0OO0O0OOOOO0OOOO =set (self .__O0O00OO000OO00O0O .columns .tolist ())#line:50
            for OO00O00OOO0OOOOOO in O0O000OOO000O0O0O :#line:51
                if OO00O00OOO0OOOOOO not in O0OO0O0OOOOO0OOOO :#line:52
                    ...
                    self .__O0O00OO000OO00O0O =pd .read_csv ("./ATR_result.csv",encoding ="gb2312")#line:58
                    break #line:59
    ...
    def __O0OOO0000OOOO0O00 (O00O0O0OOOO0OOOO0 ,OO000OO0OOOOO0OOO ,O00OO0OO00OO00000 =False ,OO000O0O0OOOOO0OO =False ):#line:168
        ...
        if O00O0O0OOOO0OOOO0 .__showlogs :#line:177
        ...
        if O00O0O0OOOO0OOOO0 .__showlogs :#line:180
    ...
    def __OOO00OO000OOO0O00 (OO00O00OOO00O0O00 ,O0O00OO0O00OOOOOO ):#line:201
        ...
        while not OOO0OO0OO00O00OO0 :#line:212
            ...
            OOO000OO00OOO0O00 =threading .Timer (OO00O00OOO00O0O00 .__installtimelimit ,O0000O00000O00O0O ,[OO00OOOO0OOOO0OO0 ])#line:214
    ...
    def __O0O000OO00O0OOO00 (O000O00000O0O00O0 ,OO0OOO00O0O000000 ,OO00OOO0000000OOO ):#line:458
        ""#line:464
        OOOO0OOO000000000 ="%s/%s-%s.pcap"%(O000O00000O0O00O0 .__pcap_folder ,OO00OOO0000000OOO ,O000O00000O0O00O0 .__brand )#line:465
    ...
    def __O00OO0OO00OO00O0O (O0000OO0OOO0OOO0O ,OOO000000O0OO000O ,OOOO0O0O00O00O0OO ,OO00O0OOOOO000OOO ,O0O000O00O00O0OO0 ):#line:482
        ...
        for O0O0000OOOO0OO0OO in ["IPv4","IPv6"]:#line:493
            for OOOO0O0000O0OO0OO in ["rx_packets","rx_bytes","tx_bytes","tx_packets","rx_tcp_bytes","rx_tcp_packets","rx_udp_bytes","rx_udp_packets","tx_tcp_bytes","tx_tcp_packets","tx_udp_bytes","tx_udp_packets"]:#line:496
                OO00O0O0O000O0OOO ["%s-%s-%s"%(O0000OO0OOO0OOO0O .__brand ,O0O0000OOOO0OO0OO ,OOOO0O0000O0OO0OO )]=0 #line:497
        try :#line:498
            ...
            with open (OOO000000O0OO000O ,"rb")as OOOO0O0000O0OO0OO :#line:503
                ...
                for OOOOOOO0OO00OO00O ,OOO0O0O000OO00OO0 in O0000O00O0O0OO0O0 :#line:505
                    try :#line:506
                        ...
                        continue #line:561
                    OO00O0O0O000O0OOO ["%s-%s-%s_packets"%(O0000OO0OOO0OOO0O .__brand ,O0O0000OOOO0OO0OO ,O00OOO00O00000000 )]+=1 #line:562
                    OO00O0O0O000O0OOO ["%s-%s-%s_bytes"%(O0000OO0OOO0OOO0O .__brand ,O0O0000OOOO0OO0OO ,O00OOO00O00000000 )]+=OOO00000OOO00O00O #line:563
                    OO00O0O0O000O0OOO ["%s-%s-%s_%s_packets"%(O0000OO0OOO0OOO0O .__brand ,O0O0000OOOO0OO0OO ,O00OOO00O00000000 ,O000OO00OOO000OO0 )]+=1 #line:564
                    OO00O0O0O000O0OOO ["%s-%s-%s_%s_bytes"%(O0000OO0OOO0OOO0O .__brand ,O0O0000OOOO0OO0OO ,O00OOO00O00000000 ,O000OO00OOO000OO0 )]+=OOO00000OOO00O00O #line:565
            OO000O00OOOO000O0 =OO00O0O0O000O0OOO ["%s-IPv4-rx_bytes"%(O0000OO0OOO0OOO0O .__brand )]+OO00O0O0O000O0OOO ["%s-IPv4-tx_bytes"%(O0000OO0OOO0OOO0O .__brand )]#line:566
            O0OO00OOOO00000O0 =OO00O0O0O000O0OOO ["%s-IPv6-rx_bytes"%(O0000OO0OOO0OOO0O .__brand )]+OO00O0O0O000O0OOO ["%s-IPv6-tx_bytes"%(O0000OO0OOO0OOO0O .__brand )]#line:567
            O00O000O0O00OO0OO =OO00O0O0O000O0OOO ["%s-IPv4-rx_packets"%(O0000OO0OOO0OOO0O .__brand )]+OO00O0O0O000O0OOO ["%s-IPv4-rx_packets"%(O0000OO0OOO0OOO0O .__brand )]#line:568
            O00O000000O0O00OO =OO00O0O0O000O0OOO ["%s-IPv6-rx_packets"%(O0000OO0OOO0OOO0O .__brand )]+OO00O0O0O000O0OOO ["%s-IPv6-rx_packets"%(O0000OO0OOO0OOO0O .__brand )]#line:569
            if O0O000O00O00O0OO0 >1 and O0OO00OOOO00000O0 ==0 :#line:570
                raise Exception ("Bytes of IPv6 is zero")#line:571
            OO00O0O0O000O0OOO ["%s-IPv6Rate-bytes"%(O0000OO0OOO0OOO0O .__brand )]="%.2f%%"%(O0OO00OOOO00000O0 *100.0 /(O0OO00OOOO00000O0 +OO000O00OOOO000O0 ))#line:572
            OO00O0O0O000O0OOO ["%s-IPv6Rate-packets"%(O0000OO0OOO0OOO0O .__brand )]="%.2f%%"%(O00O000000O0O00OO *100.0 /(O00O000000O0O00OO +O00O000O0O00OO0OO ))#line:573
            ...
            if O0000OO0OOO0OOO0O .__showlogs :#line:585
    ...
    def go (O0OO00000OOO0O0OO ):#line:637
        ...
        if OO0O0O0OO0OO00OO0 [1 ]:#line:643
            if not O0OO00000OOO0O0OO .__tf_flag :#line:644
            ...
            O0OO0O000O0OOOO0O =len (O0OO00000OOO0O0OO .__file_info )#line:658
            for O0OO000OO0O00O00O ,OOO00000OOO00OOO0 in enumerate (O0OO00000OOO0O0OO .__file_info ):#line:659
                OO0OO00000O0000OO =OOO00000OOO00OOO0 [0 ]#line:660
                OOO0O0OO00OOOO0OO =O0OO00000OOO0O0OO .__pcapsizethreshold if OOO00000OOO00OOO0 [1 ]==0 else OOO00000OOO00OOO0 [1 ]#line:661
                O00OOOOOOOO000O00 =O0OO00000OOO0O0OO .__maxpcapsizethreshold if OOO00000OOO00OOO0 [2 ]==0 else OOO00000OOO00OOO0 [2 ]#line:662
                O0O000O00O0OOOO00 =O0OO00000OOO0O0OO .__monkey_count if OOO00000OOO00OOO0 [3 ]==0 else OOO00000OOO00OOO0 [3 ]#line:663
                ...
                OO0000OO00OOO0OO0 ="%s/%s"%(O0OO00000OOO0O0OO .__download_folder ,OO0OO00000O0000OO )#line:666
                ...
                if not O00000O0O0O00O00O :#line:668
                    ...
                    if not O0OO00000OOO0O0OO .__tf_flag and O00000O0O0O00O00O in O0OO00000OOO0O0OO .__O0O00OO000OO00O0O ["PackageName"].tolist ()and not np .isnan (O0OO00000OOO0O0OO .__O0O00OO000OO00O0O [O0OO00000OOO0O0OO .__O0O00OO000OO00O0O ["PackageName"]==O00000O0O0O00O00O ]["%s-IPv4-rx_packets"%(O0OO00000OOO0O0OO .__brand )].tolist ()[0 ]):#line:672
                        ...
                        if not O0OO00000OOO0O0OO .__tf_flag :#line:685
                            ...
                            while OO0OO000O0O0O00OO >0 :#line:690
                                ...
                                if O0OO00000OOO0O0OO .__onlyhuman :#line:696
                                    ...
                                    print ("You can operate on the application for %d seconds now!\n"%(O0OO00000OOO0O0OO .__wait_time ),end ='',flush =True )#line:705
                                    time .sleep (O0OO00000OOO0O0OO .__wait_time )#line:706
                        ...
                        if O0OO00000OOO0O0OO .__disableapp :#line:737
